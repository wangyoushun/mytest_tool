...
public class DateUtils {
	...
	private static final Map<String, String> DATE_FORMAT_REGEXPS = new HashMap<String, String>() {/**
		 * 
		 */
		private static final long serialVersionUID = -5701568043413922798L;
	...
	@Test
	public void test(){
		String determineDateFormat = DateUtils.determineDateFormat("2015-10-19");
		System.out.println(determineDateFormat);
	}
}
