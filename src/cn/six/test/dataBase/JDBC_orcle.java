...
//        delete();   //删除记录     
    ...
    public static void insert() {    
        ...
        try {    
            String sql = "INSERT INTO test_user(id,user_name,test_id)"    
                    + " VALUES (112,'Tom1',112)";  // 插入数据的sql语句     
    ...
    public static void query() {    
        ...
        conn = getConnection(); //同样先要获取连接，即连接到数据库     
        try {    
            String sql = "select * from test_user";     // 查询数据的sql语句     
            st = (Statement) conn.createStatement();    //创建用于执行静态sql语句的Statement对象，st属局部变量     
...
/*    public static Connection getConnection() {    
    ...
    public static Connection getConnection(){    
    	  String url="jdbc:oracle:thin:@172.31.2.161:1521:ACCOUNT";  
    	  String user="account"; 
