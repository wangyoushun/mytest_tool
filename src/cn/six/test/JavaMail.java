...
/**
 * @author : wangyoushun
 * @createTime : 2017年8月22日 下午2:43:36
 * @version : 1.0
 * @description
 */
public class JavaMail {// 发件人的 邮箱 和 密码（替换为自己的邮箱和密码）
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("F://01.png")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("F://18565472282.csv"));  // 读取本地文件
