...
//			properties.put("mail.smtp.ssl.socketFactory", sf);
		...
		logger.debug("=sessionProperties= " + sessionProperties.toString());
		boolean ssl = PropUtil.getBooleanSessionProperty(session, "mail." + "smtp" + ".ssl.enable", false);
		logger.debug("=ssl=" + ssl);
//		if (!ssl) {
//			properties.put("mail.smtp.ssl.enable", true);
//			session = Session.getInstance(properties);
//			logger.debug("=sessionProperties=new= " + sessionProperties.toString());
//		}
